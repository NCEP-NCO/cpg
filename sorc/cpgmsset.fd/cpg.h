...
typedef struct {
    ...
    f77r8 maxtemp;                /* maximum temperature for the station */
    f77r8 maxt_sf;                /* so far maximum temperature for the station */
    f77r8 mintemp;                /* minimum temperature for the station */
    f77r8 mint_sf;                /* so far minimum temperature for the station */
} stinfo;
